...
public class ConditionedRouteBuilderTest {

    RouteMap map = null;
    ConditionedRouteBuilder builder = new ConditionedRouteBuilder();
    TrainStation a;
    TrainStation b;
    TrainStation c;
    TrainStation d;
    ...
    public void testGetResult(){
        List<TrainStation> stations = new ArrayList<TrainStation>(Arrays.asList(a,b));
        int distance = builder.getNumRoutes(stations,map,6);
